<div class="container">
	<h1 class="jumbotron">Cadastro de Livro</h1>
	...
	<div class="row">
		...
		<form method="post" action="">
			<div class="form-group">
				...
				<input type="text" id="nome" name="nome" class="form-control" value="<?= set_value('nome') ?>" />
			</div>
			<div class="form-group">
				<label for="autor">Autor:</label>
				<input type="text" id="autor" name="autor" class="form-control" value="<?= set_value('autor') ?>" />
			</div>
			<div class="form-group">
